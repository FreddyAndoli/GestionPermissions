...
router.post('/', authMiddleware, requirePermission('leave_types.create'), asyncHandler(async (req: Request, res: Response) => {
...
router.put('/:id', authMiddleware, requirePermission('leave_types.update'), asyncHandler(async (req: Request, res: Response) => {
...
router.delete('/:id', authMiddleware, requirePermission('leave_types.delete'), asyncHandler(async (req: Request, res: Response) => {
  const id = parseInt(req.params.id);
