    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-slate-900 p-4">
      ...
      >
        ...
        <p className="text-sm text-gray-500 dark:text-slate-400 mb-6">
          Saisissez le code reçu par email ou Telegram, puis créez un nouveau mot de passe.
        </p>
        ...
        {success ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading || !email || otp.length !== 6 || !newPassword || newPassword.length < 6 || newPassword !== confirmPassword}
